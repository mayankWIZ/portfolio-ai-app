...
class BaseAgent:
    def __init__(self, name, description):
        ...
        print("setting api key", self.api_key)
...
def project_agent_endpoint():
    ...
    if "e-commerce" in message.lower() or "ecommerce" in message.lower():
        ...
        "data" in message.lower()
        or "visualization" in message.lower()
        or "dashboard" in message.lower()
    ):
        project_id = "project3"

    if project_id and (
        "tell me more" in message.lower() or "details" in message.lower()
    ):
...
def career_agent_endpoint():
    ...
    if "skills" in message.lower():
        ...
        "job" in message.lower()
        or "position" in message.lower()
        or "role" in message.lower()
    ):
...
def client_agent_endpoint():
    ...
    if "services" in message.lower() or "offerings" in message.lower():
        ...
        "proposal" in message.lower()
        or "quote" in message.lower()
        or "estimate" in message.lower()
    ):
...
def research_agent_endpoint():
    ...
    if "compare" in message.lower() and (
        "vs" in message.lower() or "versus" in message.lower()
    ):
